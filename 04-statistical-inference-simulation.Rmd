---
title: "FIN7028: Times Series Financial Econometrics 4"
...
knitr::opts_chunk$set(warning = FALSE, message = FALSE,out.width = "40%")
pacman::p_load('tidyverse','fontawesome','xaringanExtra','xaringanthemer','bayesplot','arm',"rstanarm","bayesplot",install=FALSE)
use_panelset()
use_tile_view()
style_mono_accent(
  base_color = "#1c5253",
...
### Professor beauty and teaching evaluations

```{r}
knitr::include_graphics("img/beauty.png")
```

---
class: middle

## Frequentist inferennce

### Does beauty predict student evaluations?

```{r}
display(lm(eval~beauty,data=profbeautyeval))
```
...
```{r bayesian, echo=TRUE, eval=FALSE}
